...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var interactCss = [
      ...
      ".qjump-msg-actions{display:flex;align-items:center;gap:4px;padding:0 4px}",
      ".qjump-msg-ref-summary{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px;padding:2px 0}",
      ".qjump-msg-copy-btn{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:transparent;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex;font-size:12px}",
    ...
    function QJumpUserMessage(props) {
      ...
      return React.createElement("div", { className: "qjump-msg-row", "data-time-hover-root": true },
        ...
        React.createElement("div", { className: "qjump-msg-actions" },
          React.createElement("button", { className: "qjump-msg-copy-btn", type: "button", "aria-label": "qjump-copy", title: "复制", onClick: handleCopy },
            React.createElement("span", { dangerouslySetInnerHTML: { __html: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>' } })
          ),
          React.createElement("button", { className: "qjump-msg-copy-btn", type: "button", "aria-label": "qjump-edit", title: "编辑并重新发送", onClick: function () { setEditDraft(bodyText); setEdit(true); } },
