...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      ".qjump-scroll::before{content:'';position:absolute;left:0;top:8%;bottom:8%;width:1.5px;border-radius:2px;background:linear-gradient(180deg,transparent,rgba(77,107,254,.6) 18%,rgba(77,107,254,.6) 82%,transparent);opacity:0;transform:scaleY(.6);transition:opacity .3s ease,transform .3s ease}",
      ...
      ".qjump-scroll:focus-visible .qjump-dot{box-shadow:0 0 10px rgba(77,107,254,.55)}",
