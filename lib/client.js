...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      ".qjump-scroll:focus-visible{border-radius:4px;box-shadow:0 0 0 3px rgba(77,107,254,.3)}",
        ...
        return slots.register(
          ...
          function (props) {
            ...
            useEffect(function () {
              ...
              var ro = typeof ResizeObserver !== "undefined" ? new ResizeObserver(function () { syncGeometry(); syncActive(); }) : null;
              if (ro) ro.observe(scrollEl);
              var mo = typeof MutationObserver !== "undefined" ? new MutationObserver(function () { collect(); syncActive(); }) : null;
              if (mo) mo.observe(scrollEl, { childList: true, subtree: true });
