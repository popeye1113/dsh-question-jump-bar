...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      /* 当前：底部磨砂光晕（无呼吸，恒定亮度） */
      ".qjump-scroll::after{content:'';position:absolute;left:50%;bottom:0;transform:translateX(-50%);width:85%;height:100%;border-radius:16px;background:radial-gradient(ellipse at center,rgba(200,205,212,.45),rgba(200,205,212,0) 80%);filter:blur(8px);opacity:0;transition:opacity .35s ease;pointer-events:none}",
      ".qjump-scroll:focus-visible::after{opacity:1}",
