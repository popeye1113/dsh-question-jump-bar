...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      ".qjump-scroll{position:relative;width:32px;height:100%;cursor:pointer;pointer-events:auto;outline:none;border-radius:16px;transition:background .25s ease,box-shadow .25s ease}",
      ".qjump-scroll:focus-visible{background:linear-gradient(180deg,rgba(77,107,254,.16),rgba(77,107,254,.05));box-shadow:0 0 0 1px rgba(77,107,254,.22),0 0 14px rgba(77,107,254,.12)}",
