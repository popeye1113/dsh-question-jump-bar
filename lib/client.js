...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      /* 当前：底部磨砂光晕 */
      ".qjump-scroll::after{content:'';position:absolute;left:50%;bottom:-14px;transform:translateX(-50%);width:76%;height:38%;border-radius:50%;background:radial-gradient(ellipse at center,rgba(200,205,212,.38),rgba(200,205,212,0) 70%);filter:blur(5px);opacity:0;transition:opacity .35s ease;pointer-events:none}",
